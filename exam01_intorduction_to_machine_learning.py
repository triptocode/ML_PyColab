# -*- coding: utf-8 -*-
"""exam01_Intorduction_to_machine_learning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qVujvGYB4oLqL64Gg_fKoYtzrEh0KVmX
"""
...
https://www.youtube.com/watch?v=aF03asAmQbY&list=WL&index=8&ab_channel=EO%EC%9D%B4%EC%98%A4
...
fit_hist2 = model2.fit(noised_scaled_data_C,
                      noised_scaled_data_F, epochs=20)
...
print('화씨온도로',
      np.around(model2.predict([celsius_value/100])*100)[0][0], '입니다.')